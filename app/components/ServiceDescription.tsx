...
//     <ul className="grid grid-cols-2  gap-x-10  text-left text-[15px] font-semibold text-gray-600">
...
// <div className='-mt-20 bg-[#BCA184] relative'>
// <p className="text-white font-regular text-center  lg:mt-25 mt-30 md:py-16 text-2xl font-bold">
//   You might want also like this
// </p>

// <div
//   ref={scrollRef}
//   className="w-full p-4 rounded-lg mt-4 overflow-x-auto scrollbar-hide cursor-grab"
...
//         <ul className="text-left text-xs grid grid-cols-2 sm:text-sm pl-4 text-gray-300 mt-2 space-y-1">
//           {features.map((feature, index) => (
//             <li key={index}>{feature}</li>
//           ))}
//         </ul>
